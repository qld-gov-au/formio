...
## Consume this library in Form.io builder
...
Or you could use our [FormioScript](?path=/docs/helpers-formioscript--page) help to lazy load all necessary formio scripts in your application.
...
Please refer to [this page](?path=/docs/helpers-formioscript--page).

## Use the FormioLoader helper

Please refer to [this page](?path=/docs/helpers-formioloader--page).
