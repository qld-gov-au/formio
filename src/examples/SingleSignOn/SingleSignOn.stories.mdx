...
To allow sso on FormIO, there is some extra hoops you need to jump through, there may also be a way to have it half way through your form.
...
<Canvas withSource="open">
  <Story name="Demo">{() => createSSoForm()}</Story>
</Canvas>
