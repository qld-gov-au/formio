...
User needs to obtain a franchise API key for using this component, by entering it in the `Provider` options in the component builder, please contact [qol.development@smartservice.qld.gov.au](mailto:qol.development@smartservice.qld.gov.au)(TBC) to request an API key.
